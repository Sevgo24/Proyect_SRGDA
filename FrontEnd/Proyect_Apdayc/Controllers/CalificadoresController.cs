...
{
    public class CalificadoresController : Base
    {
        //
        // GET: /Calificadores/
        ...
        public JsonResult Obtiene(decimal id)
        {
            ...
            catch (Exception ex)
            {
                ...
                ucLogApp.ucLog.GrabarLogError("SGRDA", UsuarioActual, "Obtener calificadores", ex);
            }
        ...
        public JsonResult Eliminar(decimal codigo)
        {
            ...
            catch (Exception ex)
            {
                ...
                ucLogApp.ucLog.GrabarLogError("SGRDA", UsuarioActual, "Elminar calificadores", ex);
            }
            return Json(retorno, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult Insertar(BECalificador entidad)
        {
            ...
            catch (Exception ex)
            {
                retorno.result = 0;
                retorno.message = string.Format("{0} - {1}", Constantes.MensajeGenerico.MSG_ERROR_GENERICO, ex.Message);
                ucLogApp.ucLog.GrabarLogError("SGRDA", UsuarioActual, "Insertar calificadores", ex);
            }
            return Json(retorno, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult DownloadReport(string format)
        {
            ...
            lista = new BLREC_QUALIFY_CHAR().Get_REC_QUALIFY_CHAR();
