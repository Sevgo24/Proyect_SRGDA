...
{
    public class EstablecimientoAdministracionController : Base
    {
        ...
        public static string K_SESION_EST_CONSULTA_SOC = "__DTOEstTmp";
        public static string K_SESION_EST_CONSULTA_SOC_SEG = "__DTOEstSegTmp";
        ...
        List<DTOEstablecimiento> EstList = new List<DTOEstablecimiento>();
        ...
        public List<DTOEstablecimiento> EstConsultaTmp
        {
            get
            {
                return (List<DTOEstablecimiento>)Session[K_SESION_EST_CONSULTA_SOC];
            }
            set
            {
                Session[K_SESION_EST_CONSULTA_SOC] = value;
            }
        }
        public List<DTOEstablecimiento> EstDestinoTmp
        {
            get
            {
                return (List<DTOEstablecimiento>)Session[K_SESION_EST_CONSULTA_SOC_SEG];
            }
            set
            {
                Session[K_SESION_EST_CONSULTA_SOC_SEG] = value;
            }
        }
        ...
        public JsonResult ConsultaGeneralEstablecimiento(int skip, int take, int page, int pageSize, string group, decimal Tipoestablecimiento, decimal? SubTipoestableimiento, string Nombreestablecimiento, decimal Socio, string Tipodivision, decimal? Division, int estado)
        {
            ...
            var lista = new BLEstablecimiento().ConsultaGeneralEstablecimiento(Tipoestablecimiento, SubTipoestableimiento, Nombreestablecimiento, Socio, Tipodivision, Division, estado,0, page, pageSize);
        ...
        //                BPS_ID = x.CodigoAsociado,
        //                OWNER = GlobalVars.Global.OWNER,
        //                BPS_MAIN = x.EsContacto == "1" ? true : false,
        //                LOG_USER_CREAT = UsuarioActual
        //            });
        //        });
        //    }
        ...
        public JsonResult ConsultaRucSocio(string ruc)
        {
            Resultado retorno = new Resultado();
            try
            {
                if (!isLogout(ref retorno))
                {
                    Session.Remove(K_SESION_EST_CONSULTA_SOC);
                    Session.Remove(K_SESION_EST_CONSULTA_SOC_SEG);

                    var EstOrigen = new BLEstablecimiento().ObtenerEstablecimientoxRuc(ruc);


                    if (EstOrigen != null)
                    {
                        EstList = new List<DTOEstablecimiento>();
                        EstOrigen.ForEach(s =>
                        {
                            int valEst = 0;
                            if (EstDestinoTmp != null)
                                valEst = EstDestinoTmp.Where(x => x.Codigo == s.EST_ID).Count();

                            if (valEst == 0)
                            {
                                EstList.Add(new DTOEstablecimiento 
                                {
                                    Codigo = s.EST_ID,
                                    Nombre = s.EST_NAME,
                                    Ubigeo = s.UBIGEO
                        ...
                        EstConsultaTmp = EstList;
                    }
                    retorno.message = Constantes.MensajeGenerico.MSG_OK_GENERICO;
                    retorno.data = Json(EstConsultaTmp, JsonRequestBehavior.AllowGet);
                    retorno.result = 1;
                }
            }
            catch (Exception ex)
        ...
        public JsonResult ListarEstablecimientoA()
        {
            listar = EstConsultaTmp;
            Resultado retorno = new Resultado();
            try
            {
                StringBuilder shtml = new StringBuilder();
                shtml.Append("<table class='tblEstA' border=0 width='100%;' class='k-grid k-widget' id='tblEstablecimientoA'>");
                shtml.Append("<thead><tr>");
                shtml.Append("<th class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix' >#</th>");
                shtml.Append("<th style'width:20px' class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix'>ID</th>");
                shtml.Append("<th style'width:300px' class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix' >Nombre</th>");
                shtml.Append("<th style'width:450px' class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix' >Ubigeo</th>");
                ...
                if (listar != null)
                {
                    ...
                    {                                                                                                                  //<input type='checkbox' name='chkorigen{0}' value='chkorigen{0}'/></td>"
                        shtml.Append("<tr style='background-color:white'>");
                        shtml.AppendFormat("<td style='width:2.5px; cursor:pointer;text-align:right; width:2.5px';' class='IDCellOri' ><input type='checkbox' id='{0}' name='Check' class='Check' />", "chkEstOrigen" + item.Codigo);
                        shtml.AppendFormat("<td style='width:20px;cursor:pointer;text-align:right'; class='IDEstOri'>{0}</td>", item.Codigo);
                        shtml.AppendFormat("<td style='width:300px;cursor:pointer;text-align:left';'class='NomEstOri'>{0}</td>", item.Nombre);
                        shtml.AppendFormat("<td style='width:450px;cursor:pointer;text-align:left';'class='NomUbgOri'>{0}</td>", item.Ubigeo);
                        shtml.AppendFormat("</td>");
                        shtml.Append("</tr>");
                        shtml.Append("</div>");
                        shtml.Append("</td>");
        ...
        public JsonResult ListarEstablecimientoB()
        {
            listar = EstDestinoTmp;
            if (listar == null)
                listar = new List<DTOEstablecimiento>();
            Resultado retorno = new Resultado();
            try
            {
                StringBuilder shtml = new StringBuilder();
                shtml.Append("<table class='tblEstB' border=0 width='100%;' class='k-grid k-widget' id='tblEstablecimientoB'>");
                shtml.Append("<thead><tr>");
                shtml.Append("<th class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix' >#</th>");
                shtml.Append("<th style'width:20px' class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix'>ID</th>");
                shtml.Append("<th style'width:300px' class='ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix' >Nombre</th>");
                ...
                if (listar != null)
                {
                    ...
                    {
                        shtml.Append("<tr style='background-color:white'>");
                        shtml.AppendFormat("<td style='width:2.5px; cursor:pointer;text-align:center; ';' class='IDCellOri' ><input type='checkbox' id='{0}' name='Check' class='Check' />", "chkEstDes" + item.Codigo);
                        shtml.AppendFormat("<td style='width:20px;cursor:pointer;text-align:right;background-color:none'; class='IDEstDes'>{0}</td>", item.Codigo);
                        shtml.AppendFormat("<td style='width:300px;cursor:pointer;text-align:left'; 'class='NomEstDes'>{0}</td>", item.Nombre);
                        shtml.AppendFormat("<td style='width:450px;cursor:pointer;text-align:left';'class='NomUbgDes'>{0}</td>", item.Ubigeo);
                        shtml.AppendFormat("</td>");
                        shtml.Append("</tr>");
                        shtml.Append("</div>");
                        shtml.Append("</td>");
        ...
        public JsonResult EstArmaTemporalesOriginal(List<DTOEstablecimiento> ReglaValor)
        {
            Resultado retorno = new Resultado();
            try
            {
                if (!isLogout(ref retorno))
                {
                    ...
                    {
                        listarEstSeg = EstDestinoTmp;
                    }
                    //Arma la segunda lista origen

                    foreach (var item in listarEstSeg.OrderBy(x => x.Codigo))
                    {
                        foreach (var item2 in EstConsultaTmp.Where(x => x.Codigo == item.Codigo))
                        {
                            if (EstDestinoTmp == null)
                            {
                                EstDestinoTmp = new List<DTOEstablecimiento>();
                            }
                            if (item2 != null)
                            {
                                EstDestinoTmp.Add(new DTOEstablecimiento
                                {
                                    Codigo = item2.Codigo,
                                    Nombre = item2.Nombre,
                                    Ubigeo = item2.Ubigeo
                    ...
                    foreach (var item in listarEstSeg.OrderBy(x => x.Codigo))
                    {
                        EstConsultaTmp = EstConsultaTmp.Where(x => x.Codigo != item.Codigo).ToList();
                    }
                    retorno.message = Constantes.MensajeGenerico.MSG_OK_GENERICO;
                    retorno.data = Json(EstConsultaTmp, JsonRequestBehavior.AllowGet);
                    retorno.result = 1;
        ...
        public JsonResult EstArmaTemporalesDestino(List<DTOEstablecimiento> ReglaValor)
        {
            Resultado retorno = new Resultado();
            try
            {
                if (!isLogout(ref retorno))
                {
                    ...
                    foreach (var item in listarEstSeg.OrderBy(x => x.Codigo))
                    {
                        if (EstConsultaTmp == null)
                        {
                            EstConsultaTmp = new List<DTOEstablecimiento>();
                        }
                        if (item != null)
                        {
                            EstConsultaTmp.Add(new DTOEstablecimiento
                            {
                                Codigo = item.Codigo,
                                Nombre = EstDestinoTmp.Where(x => x.Codigo == item.Codigo).FirstOrDefault().Nombre,
                                Ubigeo = EstDestinoTmp.Where(x => x.Codigo == item.Codigo).FirstOrDefault().Ubigeo
                            });
                        }
                    }
                    ...
                    foreach (var item in listarEstSeg.OrderBy(x => x.Codigo))
                    {
                        if (EstDestinoTmp != null)
                        {
                            EstDestinoTmp = EstDestinoTmp.Where(x => x.Codigo != item.Codigo).ToList();
                        }
                    }

                    retorno.message = Constantes.MensajeGenerico.MSG_OK_GENERICO;
                    retorno.data = Json(EstDestinoTmp, JsonRequestBehavior.AllowGet);
                    retorno.result = 1;
                }
            }
            catch (Exception ex)
        ...
        public JsonResult AgruparEstablecimiento(List<BEEstablecimiento> ReglaValor)
        {
            Resultado retorno = new Resultado();
            try
            {
                List<BEEstablecimiento> ListEstB = new List<BEEstablecimiento>();
                var exito = false;

                //foreach (var item in SocioDestinoTmp)
                //{
                if (EstDestinoTmp != null)
                {
                    EstDestinoTmp.ForEach(x => { ListEstB.Add(new BEEstablecimiento { EST_ID = x.Codigo }); });
                }
                //}

                var IdOrigen = ReglaValor.FirstOrDefault().EST_ID;

                exito = new BLEstablecimiento().AgruparEstablecimiento(GlobalVars.Global.OWNER, ListEstB, IdOrigen);

                if (exito)
                {
                    EstDestinoTmp.Clear();
                    retorno.result = 1;
                    retorno.message = "El Establecimiento ha sido agrupado exitosamente.";
                }
                else
                {
                    retorno.result = 1;
                    retorno.message = "La Agrupación de Establecimiento no ha sido satisfactoria.";
                }
            }
            catch (Exception ex)
            {
