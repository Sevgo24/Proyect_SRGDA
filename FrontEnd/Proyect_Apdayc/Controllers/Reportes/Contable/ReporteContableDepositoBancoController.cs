...
{
    public class ReporteContableDepositoBancoController : Base
    {
        // GET: ReporteContableDepositoBanco

        private const string K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO = "___K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO  ";

        public ActionResult Index()
        {
            Session.Remove(K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO);
            return View();
        }
        ...
        private List<BEREPORTE_DEPOSITO_BANCO> ListaReporteDepositoBancoTmp
        {
            get
            {
                return (List<BEREPORTE_DEPOSITO_BANCO>)Session[K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO];
            }
            set
            {
                Session[K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO] = value;
            }
        }
        ...
        public ActionResult ReporteDepositoBanco(string fini, string ffin, string formato, string rubro, string idoficina, string nombreoficina)
        {
            ...
            try
            {
                ...
                //{
                localReport.ReportPath = Server.MapPath("~/Reportes/Contable/R_REC_REPORTE_CONTABLE_DEPOSITO_BANCO.rdlc");
                ...
                string fechaInicioPeriodo = ListaReporteDepositoBancoTmp[0].FECHA_INI;
                string fechaFinPeriodo = ListaReporteDepositoBancoTmp[0].FECHA_FIN;
                if (listar.Count > 0)
                {
        ...
        public ActionResult ReporteTipo(string fini, string ffin, string formato, string rubro, string idoficina, string nombreoficina,decimal idContable)
        {
            Session.Remove(K_SESSION_LISTA_CONTABLE_REPORTE_DEPOSITO_BANCO);
            Resultado retorno = new Resultado();
            string format = formato;
            ...
            try
            {
                ...
                listar = new BLREPORTE_DEPOSITO_BANCARIO().ListarReporteContableDepositoBancario(fini, ffin, idoficina, idContable, rubrofiltro);
