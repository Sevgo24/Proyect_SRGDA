...
{
    public class ProveedorAdministracionController : Base
    {
        ...
        public JsonResult ListarDocumento()
        {
            ...
            try
            {
                ...
                if (documentos != null)
                {
                    ...
                    {
                        var pathWeb = System.Web.Configuration.WebConfigurationManager.AppSettings["RutaWebImgProveedor"];
        ...
        [HttpPost]
        public JsonResult Insertar(DTOUsuarioProveedor usuario)
        {
            Resultado retorno = new Resultado();
            try
            {
                ...
                obj.ECON_ID = usuario.ActividadEcon;
                obj.SUPP_LINE = usuario.LineaArticulo;
                ...
                obj.RedSocial = obtenerRedSocial();
                    ...
                    {
                        var datos = new BLUsuarioProveedor().Insertar(obj,
            ...
            if (ObservacionesTmp != null)
            {
                ObservacionesTmp.ForEach(x =>
                {
                    datos.Add(new BEObservationGral
                    {
                        ...
                        ENT_ID = Convert.ToInt32(Constantes.ENTIDAD.PROVEEDOR),
            ...
            if (ParametrosTmp != null)
            {
                ParametrosTmp.ForEach(x =>
                {
                    datos.Add(new BEParametroGral
                    {
                        ...
                        ENT_ID = Constantes.ENTIDAD.PROVEEDOR,
                        LOG_USER_CREAT = UsuarioActual
                    });
                });
            }
        ...
        private List<BEDireccion> obtenerDirecciones()
        {
            ...
            if (DireccionesTmp != null)
            {
                DireccionesTmp.ForEach(x =>
                {
                    ...
                    obj.OWNER = GlobalVars.Global.OWNER;
                    obj.ENT_ID = Constantes.ENTIDAD.PROVEEDOR;
        ...
        public JsonResult ActualizarEstado(decimal codigo)
        {
            ...
            try
            {
                ...
                var usu = new BLUsuarioProveedor();
            ...
            catch (Exception ex)
            {
                retorno.message = Constantes.MensajeGenerico.MSG_ERROR_GENERICO;
                retorno.result = 0;
                ucLogApp.ucLog.GrabarLogError("SGRDA", UsuarioActual, "obtener usuario proveedor", ex);
        ...
        [HttpPost]
        public JsonResult ObtenerUsuarioProveedor(decimal codigo)
        {

            Resultado retorno = new Resultado();
            try
            {
                BLUsuarioProveedor servicioUD = new BLUsuarioProveedor();
                var usuario = servicioUD.Obtener(codigo, GlobalVars.Global.OWNER, Constantes.ENTIDAD.PROVEEDOR);

                if (usuario != null)
                {
                    DTOUsuarioProveedor usuarioDTO = new DTOUsuarioProveedor()
                    {
                        Codigo = usuario.BPS_ID,
                        ActividadEcon = usuario.ECON_ID,
                        LineaArticulo = usuario.SUPP_LINE,
