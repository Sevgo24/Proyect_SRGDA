...
{
    public class FileUploadContactoCallCenterController : ApiController
    {
        [HttpPost]
        public KeyValuePair<bool, string> UploadTabDocContactoCallCenter()
        {
            try
            {
                var rutaUpload = GlobalVars.Global.RutaTabDocumentoContactoCallCenter;
