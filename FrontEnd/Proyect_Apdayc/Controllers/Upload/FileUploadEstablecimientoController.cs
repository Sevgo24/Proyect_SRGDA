...
{
    public class FileUploadEstablecimientoController : ApiController
    {
        [HttpPost]
        public KeyValuePair<bool, string> UploadTabDocEstablecimiento()
        {
            try
            {
                var rutaUpload = GlobalVars.Global.RutaTabDocumentoEstablecimiento;
