...
{
    public class FileUploadOficinaController : ApiController
    {
        //
        // GET: /FileUploadOficina/

        [HttpPost]
        public KeyValuePair<bool, string> UploadTabDocOficina()
        {
            try
            {
                var rutaUpload = GlobalVars.Global.RutaTabDocumentoOficina;
