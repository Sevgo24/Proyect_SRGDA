        ...
        base.init = function(){
        	...
        	$(base.options.data).each(function(index, d){
				...
				if(base.options.showDate){
				    base.eventDivs[index].html("<span class='date'>" + monthNames[d.startDate.getUTCMonth()] + " " + d.startDate.getUTCDate() + ", " + d.startDate.getUTCFullYear() + "</span><h3>" + d.title + "</h3><span>" + d.description + "</span>");
				} else {
				    base.eventDivs[index].html("<h3>" + d.title + "</h3><span>" + d.description + "</span>");
				}
				...
				base.markerDivs[index].attr("title",  monthNames[d.startDate.getUTCMonth()] + " " + d.startDate.getUTCDate() + ", " + d.startDate.getUTCFullYear() );
