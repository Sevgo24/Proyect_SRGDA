...
$(function () {
    ...
    if (id === undefined) {
        $("#divTituloPerfil").html("Establecimientos - Nuevo");
        K_ACCION_ACTUAL = K_ACCION.Nuevo;
        $("#hidOpcionEdit").val(0);
        loadTipoestablecimiento('ddlTipoestablecimiento', 0);
        loadTipoIdentificacion(0);
    } else {
        $("#divTituloPerfil").html("Establecimientos - Actualización");
    ...
    $("#btnVolver").on("click", function () {
        location.href = "../EstablecimientoAdministracion/";
    }).button();
...
function ListarDireccionxPerfil(codeEdit) {
    $.ajax({
        url: '../EstablecimientoAdministracion/ListarDireccionxPerfil',
        type: 'POST',
        data: { id: codeEdit },
        beforeSend: function () { },
...
function validarRol(control, id) {
    $.ajax({
        ...
        url: '../EstablecimientoAdministracion/ValidacionPerfil',
        type: 'POST',
        async: false,
        success: function (response) {
            var dato = response;
...
function ObtenerCaracteristicasXSubtipo(id, subid) {
    var respuesta = 0;
    $.ajax({
        url: '../EstablecimientoAdministracion/ObtenerCaracteristicasXSubtipo',
...
function QuitarCaracteristicasXSubtipo(id) {
    $.ajax({
        url: '../EstablecimientoAdministracion/QuitarCaracteristicasXSubtipo',
...
function ObtenerDatos(idSel) {
    $("#hidOpcionEdit").val(1);
    $.ajax({
        url: '../EstablecimientoAdministracion/Obtiene',
        data: { id: idSel },
        type: 'POST',
        beforeSend: function () { },
        success: function (response) {
    ...
    if (ValidarObligatorio(K_DIV_MESSAGE.DIV_ESTABLECIMIENTO, K_DIV_VALIDAR.DIV_CAB)) {
        if (estadoIdSocio) {
            ...
            //if (estado) {
                ...
                $.ajax({
                    url: '../EstablecimientoAdministracion/Insertar',
...
function AddDireccionesAll() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'POST',
        url: '../EstablecimientoAdministracion/ObtenerDireccionesAll',
        data: Direcciones,
        success: function (response) {
            var dato = response;
            validarRedirect(dato);
...
function loadDataLicencia() {
    ...
    $("#gridLicencia").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "../EstablecimientoAdministracion/usp_listar_LicenciasJson", dataType: "json", data: { EstablecimientoId: estid }
                }
            },
...
function ValidarEstablecimientoModif(ESTID) {
    ...
    $.ajax({
        ...
        url: '../EstablecimientoAdministracion/ValidarEstablecimientoModif',
        data: { ESTID: ESTID },
...
function ValidarCaractersiticasPredefinidas() {
    ...
    $.ajax({
        ...
        url: '../EstablecimientoAdministracion/ValidaCaracteristicasPredefinidas',
        //async:false PARA QUE se tenga que el jquery termine de ejecutar y no se saltee la programacion
        async: false,
        type: 'POST',
        success: function (response) {
