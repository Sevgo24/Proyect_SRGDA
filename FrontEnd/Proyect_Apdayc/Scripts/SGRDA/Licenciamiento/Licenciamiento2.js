...
function loadData(e) {
    ...
    var data_sourceLic = new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: "../Licencia/USP_LICENCIAMIENTO_LISTARPAGEJSON2",
                dataType: "json"
            },
    ...
    var gridLic = $("#grid").kendoGrid({
        ...
        columns:
            [
                ...
                { field: "MONTO", width: 18, title: "MONTO", template: "<font color='green'><a id='single_2' href=javascript:editar('${LIC_ID}') style='color:gray;text-decoration:none;font-size:11px'>  </a></font>" },
                { field: "DESCUENTO", width: 18, title: "DESCUENTO", template: "<font color='green'><a id='single_2' href=javascript:editar('${LIC_ID}') style='color:gray;text-decoration:none;font-size:11px'>  </a></font>" }
            ]
    });
}
...
function ListarLicenciaDestino() {
    ...
    $.ajax({
        //data: { BPS_ID: BPS_ID },
        url: '../Licencia/ListarLicenciasTrasladoDestino',
        type: 'POST',
        //   async: false,
        beforeSend: function () { },
        success: function (response) {
