...
$(function () {
    ...
    //$("#OficinaTransporte").hide();
    MostrarRadioButtonTransporte();
    $('#divEstado').val(0);
...
function MostrarRadioButtonTransporte() {
    $.ajax({
        //data: { codigoLic: idSel },
        url: '../ReporteEstadoCuenta/ValirdarOficinaTransporte',
        type: 'POST',
        beforeSend: function () { },
        success: function (response) {
            var dato = response;
            if (dato.result == 1) {
                //document.getElementById("tdRadioButtonTransporte")
                //document.getElementById("tdRadioButton").style.display = '';
                $("#Rd_Local").show();
                $("#Rd_Local_lbl").show();
                $("#Rd_Transporte").show();
                $("#Rd_Transporte_lbl").show();
            } else {
                $("#Rd_Local").hide();
                $("#Rd_Local_lbl").hide();
                $("#Rd_Transporte").hide();
                $("#Rd_Transporte_lbl").hide();
            }
        }
    });
};