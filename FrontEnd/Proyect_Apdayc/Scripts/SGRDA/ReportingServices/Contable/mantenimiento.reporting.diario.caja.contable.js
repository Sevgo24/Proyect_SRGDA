...
function ExportarReportef2(tipo) {
    ...
    if (validafecha == 1 && validaselecciondelCombo == 1) {
        ...
        $.ajax({
            url: '../ReporteContableDiarioCaja/ReporteContableTipo',
            type: 'POST',            
            //data: {
            ...
            success: function (response) {
                ...
                if (dato.result == 1) {
                    ...
                    //url = "../ReporteContableDiarioCaja/ReporteContableDiarioCaja?" + "fini=" + ini + "&" + "ffin=" + fin + "&"
...
function ExportarReportef(tipo) {
    ...
    //if (validafecha == 1 && validaselecciondelCombo == 1) {
    $("#contenedor").show();
    url = "http://ws2016-002/ReportServer_SSRS/Pages/ReportViewer.aspx?%2fDiarioCaja%2fContableDiarioCajaFinalV1&" +
 "fecha1=" + ini + "&" +
 "fecha2=" + fin + "&" +
...
function BuscarModalidadesXOficina(dato) {
    var soc = dato;
    $.ajax({
        url: '../ReporteContableDiarioCaja/ConsultaModalidadXOficina',
        type: 'POST',
        data: {
            IdOficina: soc
        },
...
function obtenerModalidadesSeleccionadas() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'POST',
        url: '../ReporteContableDiarioCaja/ModalidadesSeleccionadasTemporalesOriginal',
        data: ReglaValor,
        success: function (response) {
            var dato = response;
            if (dato.result == 1) {
