...
function ExportarReportef(tipo) {
    ...
    if (validafecha == 1 ) {
        ...
        if (TipoReporte == "R") {
            //alert(oficina_id)
            url = "http://ws2016-002/ReportServer_SSRS/Pages/ReportViewer.aspx?%2fDepositoBancario%2fRSDepositoBancarioFinalV1&" +
            //url = "http://ws2016-002/ReportServer_SSRS/Pages/ReportViewer.aspx?%2fLyrics%2fDepositoBancario%2fRSDepositoBancario_Excel&" +
       "OFICINA=" + oficina_id + "&" +
       "FECINI=" + ini + "&" +
       "FECFIN=" + fin + "&" +// me quede aqui
       ...
       //"conFechaConfirmacion=" + con_confirmacion + "&" +
        ...
        } else if (TipoReporte == "D") {
            url = "http://ws2016-002/ReportServer_SSRS/Pages/ReportViewer.aspx?%2fDepositoBancario%2fRSDepositoBancario_ExcelFinalV1&" +
            //url = "http://ws2016-002/ReportServer_SSRS/Pages/ReportViewer.aspx?%2fLyrics%2fDepositoBancario%2fRSDepositoBancario&" +
           "OFICINA=" + oficina_id + "&" +
           "FECINI=" + ini + "&" +
           "FECFIN=" + fin + "&" +// me quede aqui
           "conFechaIngreso=" + con_ingreso + "&" +
...
function RecuperarOficinaId() {
    $.ajax({
        url: '../Reporte_ComprobanteBancario/RecuperarOficina',
        data: {},
        async: false,
        type: 'POST',
        beforeSend: function () { },
