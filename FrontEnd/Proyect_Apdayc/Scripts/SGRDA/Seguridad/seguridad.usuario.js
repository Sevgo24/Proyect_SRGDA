...
var idContenedorBS = "ContenedormvBuscarSocio";
var btnEventoBS = "btnBuscarBS";
var idModalViewBS = "mvBuscarSocio";
var controlToSet="txtNombreSearch";
/*INICIO CONSTANTES*/
...
function loadData() {
    ...
    var usuario = $("#txtLoginSearch").val();
    ...
    $("#grid").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "../USUARIOS/usp_listar_UsuariosJson", dataType: "json", data: { usuario_red: usuario, dato: busq }
                }
            },
        ...
        columns:
           [
            ...
            { field: "USUA_ICODIGO_USUARIO", width: 10, title: "<font size=2px>ID</font>", template: "<a id='single_2'  href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_ICODIGO_USUARIO}</a>" },
            { field: "USUA_VNOMBRE_USUARIO", width: 20, title: "<font size=2px>NOMBRE</font>", template: "<a id='single_2' href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_VNOMBRE_USUARIO}</a>" },
            { field: "USUA_VAPELLIDO_PATERNO_USUARIO", width: 20, title: "<font size=2px>APELLIDO P</font>", template: "<a id='single_2' href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_VAPELLIDO_PATERNO_USUARIO}</a></font>" },
            { field: "USUA_VAPELLIDO_MATERNO_USUARIO", width: 20, title: "<font size=2px>APELLIDO M</font>", template: "<a id='single_2'  href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_VAPELLIDO_MATERNO_USUARIO}</a></font>" },
            { field: "USUA_VUSUARIO_RED_USUARIO", width: 10, title: "<font size=2px>USUARIO RED</font>", template: "<a id='single_2'  href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_VUSUARIO_RED_USUARIO}</a></font>" },
           { field: "USUA_CACTIVO_USUARIO", width: 10, title: "<font size=2px>ACTIVO</font>", template: "<a id='single_2'  href=javascript:editar('${USUA_ICODIGO_USUARIO}') style='color:gray !important;'>${USUA_CACTIVO_USUARIO}</a></font>" }
           ]
    });
}
