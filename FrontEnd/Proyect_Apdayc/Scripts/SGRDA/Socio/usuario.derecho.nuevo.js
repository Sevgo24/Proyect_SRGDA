...
function AddDireccionesAll() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'POST',
        url: '../Derecho/ObtenerDireccionesAll',
        data: Direcciones,
        success: function (response) {
            var dato = response;
            validarRedirect(dato);
...
function loadDataLicencia() {
    ...
    $("#gridLicencia").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "../Derecho/ObtenerLicenciasPorSocio", dataType: "json", data: { BPSID: BPSID }
                }
            },
...
function loadDataEstablecimientos() {
    ...
    $("#gridEstablecimiento").kendoGrid({
        dataSource: {
            ...
            transport: {
                read: {
                    url: "../Derecho/ObtenerEstablecimientosPorSocio", dataType: "json", data: { BPSID: BPSID }
                }
            },
...
function verEstablecimiento(id) {
    //location.href = "../Licencia/Nuevo?set=" + id;
    window.open("../Establecimiento/Create?id=" + id);
}
