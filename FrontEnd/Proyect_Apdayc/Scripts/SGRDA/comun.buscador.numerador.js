...
var mvInitBuscarNumerador = function (parametro) {
    ...
    elemento += '<tr>';
    elemento += '<td>Tipo</td>';
    elemento += '<td><select id="ddlTipoNum" /></td>';
    elemento += '</tr>';
        
    elemento += '<tr>';
    elemento += '<td>Serie </td>';
    elemento += '<td><input type="text" id="txtSerieCOR" style="width:75px" /></td>';
    elemento += '</tr>';
    ...
    elemento += '<td><select id="ddlEstadoCOR" /></td>';
