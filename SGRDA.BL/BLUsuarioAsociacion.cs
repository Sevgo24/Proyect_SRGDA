...
namespace SGRDA.BL
{
    public class BLUsuarioAsociacion
    {
                                ...
                                )
        {
            ...
            using (TransactionScope transa = new TransactionScope())
            {
                ...
                upd = new DAUsuarioAsociacion().Insertar(bps);

                var objUsuarioDerecho = new DAUsuarioAsociacion().Obtener(bps.BPS_ID, bps.OWNER);
        ...
        /// <returns></returns>
        public UsuarioAsociacion Obtener(decimal codigoBps, string owner, decimal tipoEntidad)
        {
            var objSocio = new DAUsuarioAsociacion().Obtener(codigoBps, owner);
            if (objSocio != null)
            {
        ...
        {
            return new DAUsuarioAsociacion().CambiarEstado(bpsId, empresa, usuModifica);
        }

        public UsuarioAsociacion ObtenerSinRelacion(decimal codigoBps, string owner)
        {
            var objSocio = new DAUsuarioAsociacion().Obtener(codigoBps, owner);
