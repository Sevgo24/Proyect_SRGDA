...
namespace SGRDA.BL
{
    public class BLUsuarioEmpleado
    {
                                ...
                                )
        {
            ...
            using (TransactionScope transa = new TransactionScope())
            {
                ...
                upd = new DAUsuarioEmpleado().Insertar(bps);

                var objUsuarioEmpleado = new DAUsuarioEmpleado().Obtener(bps.BPS_ID, bps.OWNER);
        ...
        /// <summary>
        /// Obtiene los datos del empleado con las relaciones a las tablas Direcciones,Parametro,Documento,Telefono, Correo
        /// </summary>
        /// <param name="codigoBps"></param>
        /// <param name="owner"></param>
        /// <returns></returns>
        public UsuarioEmpleado Obtener(decimal codigoBps, string owner,decimal tipoEntidad)
        {
            var objSocio= new DAUsuarioEmpleado(). Obtener(codigoBps, owner);
            if (objSocio != null) {
    ...
    /// <returns></returns>
        ...
        {
            return new DAUsuarioEmpleado().CambiarEstado(bpsId, empresa, usuModifica);
        }
        /// <summary>
        /// Obtiene los datos propios del empleado. Sin ninguna relación con las tablas que estan referenciadas
        /// </summary>
        /// <param name="codigoBps"></param>
        /// <param name="owner"></param>
        /// <param name="tipoEntidad"></param>
        /// <returns></returns>
        public UsuarioEmpleado ObtenerSinRelacion(decimal codigoBps, string owner )
        {
            var objSocio = new DAUsuarioEmpleado().Obtener(codigoBps, owner);
