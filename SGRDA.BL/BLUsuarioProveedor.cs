...
namespace SGRDA.BL
{
    public class BLUsuarioProveedor
    {
                                ...
                                )
        {
            ...
            using (TransactionScope transa = new TransactionScope())
            {
                ...
                upd = new DAUsuarioProveedor().Insertar(bps);

                var objUsuarioProveedor = new DAUsuarioProveedor().Obtener(bps.BPS_ID, bps.OWNER);
        ...
        /// <returns></returns>
        public UsuarioProveedor Obtener(decimal codigoBps, string owner,decimal tipoEntidad)
        {
            var objSocio= new DAUsuarioProveedor().Obtener(codigoBps, owner);
            if (objSocio != null) {
    ...
    /// <returns></returns>
        ...
        {
            return new DAUsuarioProveedor().CambiarEstado(bpsId, empresa, usuModifica);
        }
        public UsuarioProveedor ObtenerSinRelacion(decimal codigoBps, string owner)
        {
            var objSocio = new DAUsuarioProveedor().Obtener(codigoBps, owner);
