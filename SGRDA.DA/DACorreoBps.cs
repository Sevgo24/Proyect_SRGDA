...
namespace SGRDA.DA
{
    public class DACorreoBps
    {
        public int Insertar(BECorreoBps obs)
        {
            int retorno = 0;
           
                Database oDataBase = new DatabaseProviderFactory().Create("conexion");
                DbCommand oDbComand = oDataBase.GetStoredProcCommand("SGRDASI_CORREO_BPS");
                ...
                oDataBase.AddInParameter(oDbComand, "@MAIL_ID", DbType.Int32, obs.MAIL_ID);
