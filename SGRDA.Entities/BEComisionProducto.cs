...
{
    public class BEComisionProducto
    {
        ...
        public List<BEComisionProducto> ListaComisionPro = null;

        public BEComisionProducto()
        {
            ListaComisionPro = new List<BEComisionProducto>();
        }
