...
{
    public class BEMatrizEmpadronamiento
    {
        public List<BEMatrizEmpadronamiento> ListaMatrizEmpadronamiento { get; set; }
        public BEMatrizEmpadronamiento()
        {
            ListaMatrizEmpadronamiento = new List<BEMatrizEmpadronamiento>();
        }
        ...
        public decimal PAGO_EMPADRONAMIENTO { get; set; }
    }
}
