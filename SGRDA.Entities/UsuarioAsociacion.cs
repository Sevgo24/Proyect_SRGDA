...
{
    public partial class UsuarioAsociacion : Paginacion
    {
        /// <summary>
        /// Empresa
        /// </summary>
        ...
        public decimal? CF_PER { get; set; }
        public decimal? CF_AMO { get; set; }
        public decimal? BA_PER { get; set; }
        public decimal? BA_AMO { get; set; }
