...
namespace SGRDA.Servicio.WFCambioEstadoTv
{
    public partial class Service1 : ServiceBase
    {
        ...
        string OWNER = "";
        string ServTitLog = "SRGRDA-SERVICIO WINDOWS / CAMBIAR ESTADO AT TV /  InitializeServices / ";
        int time1 = 0;
        ...
        void myTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            try
            {
                WorkFlowBotTv serv = new WorkFlowBotTv();
                serv.CambiarATEstadoWFTV(OWNER);
            }
            catch (Exception ex)
            {
                ucLog.GrabarLogError("SRGRDA-SERVICIO WINDOWS", "CAMBIAR ESTADO AT TV", "myTimer_Elapsed", ex);
            }
